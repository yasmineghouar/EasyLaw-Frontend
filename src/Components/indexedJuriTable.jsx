...
export default function indexedJuriTable({onClick1 }) {
  return (
    <div className='flex flex-col mt-5'>
        ...
        <h1 className='mr-8 mt-5 text-xl font-cairo text-Deep_Blue text-right'>قائمة الاجتهادات القضائية المجرفة </h1> 
<div className="mt-3 flex justify-center">  
    ...
    <tr key={index} className='border-2 border-light_Blue p-4 '>
      ...
      <td className='py-2'>بوابة القانون الجزائري</td>
    </tr>
  ))}
